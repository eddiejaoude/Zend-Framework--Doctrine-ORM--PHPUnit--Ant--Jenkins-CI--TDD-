<?php
/**
 * Application Config Test Mode Test
 * 
 * @author        Eddie Jaoude
 * @package     Application
 * 
 */
class ApplicationConfigTestModeTest extends BaseTestCase
{
    /**
     * Config object
     * 
    ...
    public function setup() {
        parent::setUp();
        $this->config = new Zend_Config_Ini(APPLICATION_PATH . '/configs/application.ini', 'testing');
    }
